...
-- =============================================================================
--  Cible  : base jetable $(TestDb) (defaut : RestitutionGrapheProdHash_Test)
...
-- =============================================================================
:setvar TestDb "RestitutionGrapheProdHash_Test"

USE [$(TestDb)];
GO

-- requis : INSERT dans une table a index sur colonnes calculees (DTA_x_k)
SET ANSI_NULLS ON;
SET ANSI_PADDING ON;
