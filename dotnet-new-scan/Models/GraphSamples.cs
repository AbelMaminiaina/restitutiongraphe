...
//
// C# 8.0 : pas de collection expressions `[...]` — on écrit
// `new GraphEdge[] { ... }` et `new List<GraphSample> { ... }`.
...
namespace PathFinder.ScanMvc.Models
{
    public static class GraphSamples
    {
        ...
        private static GraphEdge E(string a, string b, int? w = null) => new GraphEdge(a, b, w);
        ...
        private static List<GraphSample> Build() => new List<GraphSample>
        {
            new GraphSample("connexe", "Graphe connexe",
                ...
                N("A", "B", "C", "D", "E", "F"),
                new GraphEdge[] { E("A","B"), E("B","C"), E("C","D"), E("D","E"), E("E","F"), E("F","A"), E("B","E") },
                false, false, GraphLayout.Circular),
            ...
            new GraphSample("non-connexe", "Graphe non connexe",
                ...
                N("A", "B", "C", "D", "E", "F", "G"),
                new GraphEdge[] { E("A","B"), E("B","C"), E("C","A"), E("D","E"), E("F","G") },
                false, false, GraphLayout.Circular),
            ...
            new GraphSample("compact", "Graphe compact (dense)",
                ...
                N("A", "B", "C", "D", "E", "F"),
                new GraphEdge[] { E("A","B"), E("A","C"), E("A","D"), E("A","E"), E("B","C"), E("B","D"),
            ...
            new GraphSample("creux", "Graphe creux (sparse)",
                ...
                N("A", "B", "C", "D", "E", "F", "G"),
                new GraphEdge[] { E("A","B"), E("B","C"), E("C","D"), E("D","E"), E("E","F"), E("F","G") },
                false, false, GraphLayout.Circular),
            ...
            new GraphSample("non-pondere", "Graphe non pondéré",
                ...
                N("A", "B", "C", "D", "E"),
                new GraphEdge[] { E("A","B"), E("A","C"), E("B","D"), E("C","D"), E("D","E") },
                false, false, GraphLayout.Circular),
            ...
            new GraphSample("pondere", "Graphe pondéré",
                ...
                N("A", "B", "C", "D", "E"),
                new GraphEdge[] { E("A","B",4), E("A","C",2), E("B","D",5), E("C","D",8), E("C","E",3), E("D","E",1) },
                false, true, GraphLayout.Circular),
            ...
            new GraphSample("oriente-dag", "Graphe orienté sans cycle (DAG)",
                ...
                N("A", "B", "C", "D", "E"),
                new GraphEdge[] { E("A","B"), E("A","C"), E("B","D"), E("C","D"), E("D","E") },
                true, false, GraphLayout.Layered),
            ...
            new GraphSample("cyclique", "Graphe orienté cyclique",
                ...
                N("A", "B", "C", "D"),
                new GraphEdge[] { E("A","B"), E("B","C"), E("C","A"), E("C","D") },
                true, false, GraphLayout.Circular),
            ...
            new GraphSample("arbre", "Arbre",
                ...
                N("A", "B", "C", "D", "E", "F", "G"),
                new GraphEdge[] { E("A","B"), E("A","C"), E("B","D"), E("B","E"), E("C","F"), E("C","G") },
                false, false, GraphLayout.Layered),
        };
    }
}
