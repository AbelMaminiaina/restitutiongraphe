...
namespace PathFinder.ScanMvc.Services
{
    public sealed class SccStatus
    {
        ...
        public int LargestSccSize { get; }
        public long DurationMs { get; }

        public SccStatus(DateTime completedAtUtc, long nodeCount, long edgeCount,
            int sccCount, int condensedEdgeCount, int largestSccSize, long durationMs)
        {
    ...
    public class SccCondensationService
    {
        ...
        public SccStatus Run()
        {
            ...
            var n = names.Count;
            var adj = BuildAdjacency(n, edgeList, false);
            var radj = BuildAdjacency(n, edgeList, true);
        ...
        public SccReach Reachable(string source, string target)
        {
            ...
            var adjacency = _condensed ?? (_condensed = _scc.LoadCondensedAdjacency());
