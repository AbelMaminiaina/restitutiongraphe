// Model (au sens MVC de ce projet) : accès à la base SQL Server
// RestitutionGraphe.
//
...
//
// Identique à dotnet-angular/backend/LineVisEdgRepository.cs (projet
// backend+frontend séparés) : même BFS bidirectionnel, volontairement
// synchrone (pas d'async/await).

using Microsoft.Data.SqlClient;

namespace PathFinder.Mvc.Models;
